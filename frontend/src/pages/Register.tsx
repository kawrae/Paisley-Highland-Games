...
import { slideL, slideR, formStagger, fieldFade, kenBurns, fadeIn } from "../lib/anim"
    ...
    return (
      <section className="container-page section">
        ...
        >
          ...
          <button onClick={() => setOk(false)} className="btn-primary mt-6">Register another competitor</button>
        </motion.div>
      </section>
    )
  }
        ...
        <div className="grid md:grid-cols-2">
          <motion.div variants={slideL} className="p-6 md:p-8">
            ...
            >
              ...
              <motion.div variants={fieldFade}>
                <button disabled={isSubmitting} className="btn-primary active:scale-[0.98]">
